...
class Sausage : public std::enable_shared_from_this<Sausage>
{
   public:
    ...
    bool IsCooked() const noexcept { return frying_start_time_.has_value() && frying_end_time_.has_value(); }
...
class Bread : public std::enable_shared_from_this<Bread>
{
   public:
    ...
    bool IsCooked() const noexcept { return baking_start_time_.has_value() && baking_end_time_.has_value(); }
